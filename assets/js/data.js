...
window.LIBRARY = (function () {
  ...
  const phases = [
    {
      ...
      resources: [
        ...
        { name: 'Type in Arabic — Lexilogos & Google Docs', where: 'lexilogos.com/keyboard/arabic.htm · docs.google.com', url: 'https://www.lexilogos.com/keyboard/arabic.htm', tag: 'free',
          note: 'Type Arabic before you install a keyboard layout: Lexilogos for single words, Google Docs (set the language to Arabic) for anything longer. Typing forces you to distinguish letters your eye still blurs together.' },
...

    {
      ...
      resources: [
        ...
        { name: 'ConversationExchange', where: 'conversationexchange.com', url: 'https://www.conversationexchange.com', tag: 'free',
          note: 'Finds exchange partners by language, country and whether you want text, voice or face-to-face — no app, no account tier, no algorithm deciding who you meet.' },
...

    {
      ...
      resources: [
        ...
        { name: 'Arabic Khatawaat', where: 'youtube.com/@ArabicKhatawaat', url: 'https://www.youtube.com/@ArabicKhatawaat', tag: 'free',
          note: 'Step-by-step MSA grammar in short, focused videos. A good second voice when a Madinah lesson explains something once and you need it explained differently.' }
      ]
    },

    {
      ...
      resources: [
        ...
        { name: 'Sahlawayhi graded readers', where: 'sahlawayhi.com', url: 'https://sahlawayhi.com', tag: 'free',
          note: 'Graded stories written for learners, pitched between a children\'s book and real prose — the rung most people are missing when Qaṣaṣ al-Nabiyyīn still feels too hard.' },
...

    {
      ...
      resources: [
        ...
        { name: 'Ayah — King Saud University', where: 'quran.ksu.edu.sa', url: 'https://quran.ksu.edu.sa', tag: 'free',
          note: 'KSU\'s Qur\'an platform: several tafsīrs, many reciters and word-level lookup in one Arabic-language interface. Useful once you want to work without English on screen.' },
...

    {
      ...
      resources: [
        ...
        { name: 'Arabic Collections Online (NYU)', where: 'dlib.nyu.edu/aco', url: 'https://dlib.nyu.edu/aco', tag: 'free',
          note: 'A properly catalogued digital library of tens of thousands of Arabic volumes, built by NYU with partner libraries. Better metadata and scan quality than hunting through archive.org.' },
  ...
  /* ------------------------------------------------- listening, TV & media */
  // Not a phase. Everything above teaches the written register; none of it
  // tells you what a room full of Emiratis sounds like. This does.
  const media = [
    { name: 'Radio Garden', where: 'radio.garden', url: 'https://radio.garden', tag: 'free', kind: 'Radio',
      note: 'Spin a globe and listen to live radio anywhere — Dubai, Abu Dhabi, Riyadh, Cairo. The lowest-friction immersion there is: no login, no lesson, just Arabic in the background while you work.' },
    { name: 'Easy Arabic (Easy Languages)', where: 'youtube.com/@EasyArabicVideos', url: 'https://www.youtube.com/@EasyArabicVideos', tag: 'free', kind: 'Street video',
      note: 'Unscripted street interviews with dual Arabic and English subtitles. The closest free thing to hearing how people actually speak, at a speed you can follow.' },
    { name: 'UAE broadcasters', where: 'Dubai TV · Abu Dhabi TV · Sharjah TV', url: 'https://www.dmi.ae', tag: 'free', kind: 'Television',
      note: 'Live Emirati television — news in fuṣḥā, everything else in Gulf dialect. Interviews and talk shows are the most useful: long stretches of one person speaking naturally.' },
    { name: 'Lingualism', where: 'youtube.com/@Lingualism', url: 'https://www.youtube.com/@Lingualism', tag: 'free', kind: 'Dialect & pronunciation',
      note: 'Clear explanations of how dialects diverge from fuṣḥā, and of the sounds English speakers get wrong. The YouTube channel is free; the books are paid and optional.' },
    { name: 'Sowt', where: 'sowt.com · podcast apps', url: 'https://www.sowt.com', tag: 'free', kind: 'Podcast',
      note: 'Arabic podcasts made for Arabic speakers — narrative journalism, no learner scaffolding. Save it for when you can follow a conversation; then it becomes the best listening you have.' },
    { name: 'SBS Arabic', where: 'sbs.com.au/language/arabic', url: 'https://www.sbs.com.au/language/arabic', tag: 'free', kind: 'News podcast',
      note: 'Australia\'s public broadcaster in Arabic: short, clearly enunciated news bulletins with free podcast feeds. A gentler step up than Al Jazeera.' }
  ];
